	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		lv.setOnItemClickListener(new AdapterView.OnItemClickListener()
		{
					...
					long id)
			{
				...
				if (device == null)
					return;
				final Intent intent = new Intent(DeviceListActivity.this,
						MainActivity.class);
				intent.putExtra(MainActivity.EXTRAS_DEVICE_NAME,
						device.getName());
				intent.putExtra(MainActivity.EXTRAS_DEVICE_ADDRESS,
						device.getAddress());
				intent.putExtra(MainActivity.EXTRAS_DEVICE_RSSI,
...
//		}
	...
	public void onClick(View v)
	{
		...
		} else
		{
			...
			scanLeDevice(false);
			scan_btn.setText(R.string.start_scan);
		}
	}
	...
	private void scanLeDevice(final boolean enable)
	{
		if (enable)
		{
			...
			mScanning = true;
			scan_flag = false;
			scan_btn.setText(R.string.stop_scan);
